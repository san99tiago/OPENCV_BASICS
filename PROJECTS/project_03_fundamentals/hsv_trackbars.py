# FIRST STEP FOR <ADD_SUB> FUNCTION (FIND OPTIMAL HSV VALUES FOR TRESHOLD)
...
def main():
    ...
    # img_path = get_img_path(img_folder_path, "test_substraction_1.png")
    img_path = get_img_path(img_folder_path, "21.jpg")
